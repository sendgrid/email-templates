...
We ask that you thoroughly test your email templates in a variety of clients before submitting a PR.

For the purposes of contributing to this repo, please submit a pull request.
...
- For each email type: create a file in the `paste-templates` directory, with a hyphenated name describing the email type, for eg: `password-reset.html` or `email-confirmation.html`.
