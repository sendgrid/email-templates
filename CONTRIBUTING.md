...
SendGrid templates built to reflect common transactional templates.
...
For new email types, create a new file in the directory, with a hyphenated name that describes the template. For examples, check **/paste-templates**.

For adding new [styles](https://sendgrid.com/blog/introducing-sendgrids-style-guide-what-is-a-style-guide-and-how-to-create-one/), create a new directory named after the 'style'.
